...
function myFuction() {
    var konfirmasi = confirm("Konfirmasi ubah mode layar");
    if (konfirmasi == true) {
        console.log("Mode Gelap");
        var element = document.body;
        element.classList.toggle("dark-mode");
        document.getElementById("judul").style.fontFamily = "arial";
        document.getElementById("judul").style.fontSize = "300%";
    } else {
        document.getElementById("judul").style.fontFamily = "times new roman";
        console.log("Mode tidak diubah");
    }
}
...
const button1 = document.getElementById("btn-i");
button1.addEventListener("click", function showInfo() {
    const x = document.getElementById("info-boy");
    if (x.style.display == "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
const button2 = document.getElementById("btn-in");
button2.addEventListener("click", function showInfo() {
    const x = document.getElementById("info-girl");
    if (x.style.display == "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
const button3 = document.getElementById("btn-ind");
button3.addEventListener("click", function showInfo() {
    const x = document.getElementById("info-solo");
    if (x.style.display == "none") {
        x.style.display = "block";
    } else {
        x.style.display = "none";
...
//     }
// });
// const button2 = document.getElementById("button-snd");
// button.addEventListener("click", function showInfo() {
//     const x = document.getElementById("info");
//     if (x.style.display == "none") {
//         x.style.display = "block";
...
//     }
// });
// const button3 = document.getElementById("button-trd");
// button.addEventListener("click", function showInfo() {
//     const x = document.getElementById("info");
//     if (x.style.display == "none") {
//         x.style.display = "block";
...
//     }
// });
// const button = document.getElementById("button-th");
// button.addEventListener("click", function showInfo() {
//     const x = document.getElementById("info");
//     if (x.style.display == "none") {
//         x.style.display = "block";
